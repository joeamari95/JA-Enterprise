...
function RefreshBtn() {
  ...
  return (
    <button onClick={handle} style={{ display:"flex",alignItems:"center",gap:6,marginTop:10,padding:"6px 13px",
      ...
      borderRadius:8,cursor:"pointer",fontFamily:"Jost,sans-serif",fontSize:9,fontWeight:400,
      color:T.teal,letterSpacing:".07em",transition:"all .3s",width:"fit-content" }}>
...
// ── SLACK MODAL ──
function SlackModal({ partner, onClose }) {
  const [step, setStep] = useState("message"); // message | reminder | done
  ...
  const reminderLabels = {
    "2days": "2 days", "1week": "1 week", "2weeks": "2 weeks", "1month": "1 month"
  };
      ...
      <div onClick={e => e.stopPropagation()} style={{ width:420,
        ...
        <div style={{ padding:"22px 22px 20px" }}>
          ...
          <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:16 }}>
            <div>
              <div style={{ fontFamily:"Georgia,serif",fontSize:16,fontWeight:300,color:T.txt,marginBottom:2 }}>
                Message {partner.pm}
              </div>
          ...
          {step === "message" && (
            <>
              ...
              <div style={{ padding:"12px 14px",background:"rgba(255,255,255,.04)",border:"1px solid rgba(255,255,255,.1)",
                borderRadius:10,fontSize:11.5,color:T.txt2,lineHeight:1.7,marginBottom:14,fontStyle:"italic" }}>
                {msg}
              </div>
              <button onClick={handleCopy} style={{ width:"100%",display:"flex",alignItems:"center",justifyContent:"center",
                ...
                borderRadius:10,cursor:"pointer",fontFamily:"Jost,sans-serif",fontSize:11,fontWeight:500,
          ...
          {step === "reminder" && !sent && (
            <>
              <div style={{ textAlign:"center",marginBottom:16 }}>
                ...
                <div style={{ fontFamily:"Georgia,serif",fontSize:14,fontWeight:300,color:T.txt,marginBottom:4 }}>
                  Set a follow-up reminder?
                </div>
                <div style={{ fontSize:10.5,color:T.txt3 }}>
                  Remind you to follow up with {partner.pm}
                </div>
              </div>
              <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:6,marginBottom:14 }}>
                {[["2days","2 Days","Best for partner outreach"],["1week","1 Week","Standard follow-up"],["2weeks","2 Weeks","Longer runway"],["1month","1 Month","Low-priority cadence"]].map(([val,label,hint]) => (
                  <button key={val} onClick={() => setReminder(val)} style={{
                    ...
                    <div style={{ fontSize:12,fontWeight:500,color:reminder===val?T.blue:T.txt,marginBottom:2 }}>{label}</div>
                    <div style={{ fontSize:8.5,color:T.txt3,letterSpacing:".02em" }}>{hint}</div>
                  </button>
                ))}
              </div>
              <button onClick={handleSetReminder} style={{ width:"100%",padding:"10px 0",
                ...
                fontFamily:"Jost,sans-serif",fontSize:11,fontWeight:500,color:T.blue,
                letterSpacing:".06em" }}>
                Set Reminder for {reminderDate()}
              </button>
              <button onClick={onClose} style={{ width:"100%",padding:"7px 0",marginTop:6,
                background:"none",border:"none",cursor:"pointer",fontSize:10,color:T.txt3,
                fontFamily:"Jost,sans-serif" }}>Skip reminder</button>
            </>
          )}
          ...
          {sent && (
            <div style={{ textAlign:"center",padding:"20px 0" }}>
              ...
              <div style={{ fontFamily:"Georgia,serif",fontSize:14,fontWeight:300,color:T.green }}>
...
function PartnerCard({ p }) {
  ...
  return (
    <>
      {modal && <SlackModal partner={p} onClose={handleSlackClose} />}
      <div style={{ background:"radial-gradient(ellipse 65% 55% at 12% 0%,rgba(255,255,255,.06) 0%,transparent 65%)",
        ...
        <div style={{ display:"flex",alignItems:"center",gap:10,padding:"10px 12px",cursor:"pointer" }}
          ...
          <div style={{ display:"flex",alignItems:"center",gap:6,flexShrink:0 }}>
            <button onClick={e => { e.stopPropagation(); setModal(true); }} style={{
              ...
              borderRadius:8,cursor:"pointer",fontFamily:"Jost,sans-serif",fontSize:9,fontWeight:500,
        ...
        {open && (
          <div style={{ padding:"0 12px 12px",borderTop:"1px solid rgba(255,255,255,.06)" }}>
            {p.confirmed && <div style={{ fontSize:8,color:T.amber,letterSpacing:".07em",fontWeight:500,
              padding:"6px 0 4px" }}>✓ CONFIRMED PARTNER</div>}
            <div style={{ fontSize:9.5,color:T.txt3,fontStyle:"italic",marginBottom:7,marginTop:p.confirmed?0:6,
              letterSpacing:".02em" }}>{p.role}</div>
    ...
    <div style={{ position:"fixed",inset:0,background:T.bg,display:"flex",alignItems:"center",
      ...
      <div style={{ position:"absolute",inset:0,pointerEvents:"none" }}>
        <div style={{ position:"absolute",width:600,height:600,top:"-15%",left:"-10%",borderRadius:"50%",
          background:"radial-gradient(ellipse,rgba(24,60,200,.18),transparent 65%)",filter:"blur(80px)",
          animation:"drift1 22s ease-in-out infinite" }} />
        <div style={{ position:"absolute",width:500,height:500,bottom:"-10%",right:"-8%",borderRadius:"50%",
          background:"radial-gradient(ellipse,rgba(45,212,180,.12),transparent 65%)",filter:"blur(80px)",
          animation:"drift2 28s ease-in-out infinite" }} />
        <div style={{ position:"absolute",width:400,height:400,top:"40%",left:"40%",borderRadius:"50%",
          background:"radial-gradient(ellipse,rgba(90,30,190,.10),transparent 65%)",filter:"blur(80px)",
          animation:"drift3 34s ease-in-out infinite" }} />
      </div>
      <Grain />
      <div style={{ ...CARD,width:340,padding:"36px 32px",textAlign:"center",position:"relative",zIndex:1,
        animation:"gateIn .5s cubic-bezier(.34,1.2,.64,1) both" }}>
        <Sheen />
        <div style={{ width:44,height:44,borderRadius:"50%",
          ...
          boxShadow:"0 0 20px rgba(122,168,255,.2),0 0 40px rgba(45,212,180,.1)" }}>
          🔒
        </div>
        <div style={{ fontFamily:"Georgia,serif",fontSize:18,fontWeight:300,color:T.txt,marginBottom:4 }}>
          Block Intelligence
        </div>
        <div style={{ fontSize:10,color:T.txt3,letterSpacing:".08em",textTransform:"uppercase",marginBottom:24 }}>
          Restricted Access
        </div>
        <input
          type="password"
          ...
          style={{ width:"100%",padding:"10px 14px",background:"rgba(255,255,255,.05)",
            ...
            borderRadius:10,color:T.txt,fontFamily:"Jost,sans-serif",fontSize:13,
            outline:"none",marginBottom:10,letterSpacing:".05em",textAlign:"center",
            animation:shake?"shake .4s ease":"none",transition:"border-color .2s" }} />
        {err && <div style={{ fontSize:9.5,color:T.red,marginBottom:8,letterSpacing:".04em" }}>
          Invalid access code
        </div>}
        <button onClick={tryUnlock} style={{ width:"100%",padding:"10px 0",
          ...
          fontFamily:"Jost,sans-serif",fontSize:11,fontWeight:500,color:T.blue,letterSpacing:".08em",
          transition:"all .2s" }}>
          Unlock →
        </button>
      </div>
...
export default function Intelligence() {
  ...
  const PARTNERS = [
    { name:"Oracle", badge:"POS / MICROS", badgeC:T.red, badgeBg:"rgba(255,96,96,.12)", badgeBr:"rgba(255,96,96,.2)",
      confirmed:true, role:"Enterprise Tech Partner — MICROS + Opera Cloud Integration",
      body:"Confirmed partner. MICROS EOL creates a joint replacement narrative. Opera Cloud API integration is live — leverage to accelerate Marriott CTO credibility.",
      action:"→ Use MICROS EOL as shared urgency. Co-sell the migration story.",
      pm:"Hayley Williams", pmTitle:"Partner Manager, Oracle Hospitality", id:"oracle" },
    { name:"NetSuite", badge:"ERP / FINANCE", badgeC:T.blue, badgeBg:"rgba(100,145,255,.12)", badgeBr:"rgba(100,145,255,.22)",
      confirmed:true, role:"Enterprise Finance Partner — ERP + Financial Reporting",
      body:"Marriott runs NetSuite across managed properties. Square ↔ NetSuite integration eliminates manual reconciliation across 8,785 properties.",
      action:"→ Joint CFO story. Gerard has existing Marriott finance team relationship.",
      pm:"Gerard Way", pmTitle:"Partner Manager, NetSuite Enterprise", id:"netsuite" },
    { name:"Courtyard GM Network", badge:"CHAMPIONS", badgeC:T.green, badgeBg:"rgba(74,222,128,.10)", badgeBr:"rgba(74,222,128,.18)",
      confirmed:false, role:"Internal Advocates — 2022 Pilot GMs, NYC + Boston",
      body:"GMs with live Square performance data. Can advocate upward to Marriott corporate tech team.",
      action:"→ Re-engage for updated case study + corporate referral to Drew Pinto's team.",
      pm:"Stevie Nicks", pmTitle:"Account Manager, Hospitality", id:"courtyard" },
  ];

  return (
    <div style={{ background:T.bg,minHeight:"100vh",fontFamily:"Jost,system-ui,sans-serif",color:T.txt,
      ...
      <div style={{ position:"fixed",inset:0,zIndex:0,pointerEvents:"none" }}>
        <div style={{ position:"absolute",width:700,height:600,top:"-12%",left:"-10%",borderRadius:"50%",
          background:"radial-gradient(ellipse,rgba(24,60,200,.15),transparent 65%)",filter:"blur(90px)",
          animation:"drift1 26s ease-in-out infinite" }} />
        <div style={{ position:"absolute",width:580,height:580,top:"20%",right:"-12%",borderRadius:"50%",
          background:"radial-gradient(ellipse,rgba(90,30,190,.11),transparent 65%)",filter:"blur(80px)",
          animation:"drift2 32s ease-in-out infinite" }} />
        <div style={{ position:"absolute",width:500,height:420,bottom:"-10%",left:"25%",borderRadius:"50%",
          background:"radial-gradient(ellipse,rgba(10,130,110,.09),transparent 65%)",filter:"blur(80px)",
          animation:"drift3 38s ease-in-out infinite" }} />
        {/* Extra micro orbs for life */}
        <div style={{ position:"absolute",width:200,height:200,top:"30%",left:"20%",borderRadius:"50%",
          background:"radial-gradient(ellipse,rgba(122,168,255,.06),transparent 70%)",filter:"blur(40px)",
          animation:"orbPulse 6s ease-in-out infinite" }} />
        <div style={{ position:"absolute",width:180,height:180,bottom:"25%",right:"20%",borderRadius:"50%",
          background:"radial-gradient(ellipse,rgba(45,212,180,.05),transparent 70%)",filter:"blur(40px)",
      ...
      <div style={{ position:"fixed",top:0,left:0,right:0,zIndex:100,height:52,display:"flex",
        ...
        <div style={{ display:"flex",alignItems:"center",gap:10 }}>
          <button onClick={() => navigate("/")} style={{ fontFamily:"Jost,sans-serif",fontSize:10,fontWeight:500,
            ...
            border:"none",cursor:"pointer",padding:"5px 16px",borderRadius:100,transition:"color .2s" }}>
            ← Back
          </button>
          <div style={{ display:"flex",alignItems:"center",gap:8,padding:"4px 14px",borderRadius:100,
            ...
            <span style={{ fontSize:10,fontWeight:500,letterSpacing:".08em",textTransform:"uppercase",
              color:"rgba(255,255,255,.96)" }}>Enterprise Intelligence</span>
          </div>
        </div>
      ...
      <div style={{ position:"relative",zIndex:1,paddingTop:52,display:"grid",
        ...
        {/* ── LEFT COL ── */}
        <div style={{ borderRight:"1px solid rgba(255,255,255,.07)",padding:"20px 16px",overflowY:"auto",
          display:"flex",flexDirection:"column",gap:16 }}>

          <Reveal delay={0}>
            <div style={{ paddingBottom:14,borderBottom:"1px solid rgba(255,255,255,.07)" }}>
              <div style={{ fontFamily:"Georgia,serif",fontSize:21,fontWeight:300,lineHeight:1.05,marginBottom:5 }}>
                Marriott<br/>International
              </div>
              <div style={{ fontSize:10,color:T.txt3,letterSpacing:".04em",lineHeight:1.7 }}>
                marriott.com · Global Hospitality<br/>Bethesda, MD · NYSE: MAR<br/>Est. 1927 · 30 Brands
              </div>
          ...
          <Reveal delay={60}>
            ...
            <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:5 }}>
              {[["8,785",T.teal,"Properties"],["141",T.blue,"Countries"],["~418k",T.txt,"Employees"],["$23.7B",T.green,"Revenue '24"]].map(([v,c,l]) => (
                <div key={l} style={{ padding:"8px 10px",
                  background:"radial-gradient(ellipse 65% 55% at 12% 0%,rgba(255,255,255,.06) 0%,transparent 65%)",
              ...
              <div style={{ gridColumn:"span 2",padding:"8px 10px",
                background:"radial-gradient(ellipse 65% 55% at 12% 0%,rgba(255,255,255,.06) 0%,transparent 65%)",
                border:"1px solid rgba(255,255,255,.08)",borderRadius:10 }}>
          ...
          <Reveal delay={120}>
            ...
            {[["Oracle MICROS","CURRENT — EOL",T.red,"rgba(255,96,96,.12)","rgba(255,96,96,.2)"],
              ["Agilysys POS","CURRENT",T.txt3,"rgba(255,255,255,.05)","rgba(255,255,255,.08)"],
              ["Square (2022)","PRIOR EVAL",T.amber,"rgba(245,166,35,.10)","rgba(245,166,35,.18)"],
              ["Opera Cloud PMS","INTEG OPP",T.green,"rgba(74,222,128,.08)","rgba(74,222,128,.15)"]].map(([n,s,c,bg,b]) => (
              <div key={n} style={{ display:"flex",alignItems:"center",justifyContent:"space-between",
                padding:"5px 9px",background:"rgba(255,255,255,.03)",border:"1px solid rgba(255,255,255,.07)",
                borderRadius:7,marginBottom:4 }}>
                <span style={{ fontSize:10.5,color:T.txt,fontWeight:400 }}>{n}</span>
                <span style={{ fontSize:8,fontWeight:500,letterSpacing:".06em",padding:"2px 7px",borderRadius:3,
                  color:c,background:bg,border:`1px solid ${b}` }}>{s}</span>
              </div>
            ))}
          </Reveal>

          {/* CONFIRMED PARTNERS — replaces Square Fit */}
          <Reveal delay={180}>
        ...
        <div style={{ padding:"20px 24px",overflowY:"auto",display:"flex",flexDirection:"column",gap:14 }}>
          ...
          <Reveal delay={40}>
            <div style={{ ...CARD,padding:16 }} className="living-card">
              ...
              <div style={{ fontSize:11.5,color:T.txt2,lineHeight:1.68,marginBottom:12,fontWeight:300 }}>
                World's largest hotel company. Hybrid franchise-managed model with complex F&B spanning full-service restaurants, bars, banquet & catering at every property tier. 2022 Square pilot in Courtyard NYC/Boston proved unit-level performance — blocked by enterprise infrastructure gaps that no longer exist. Oracle MICROS EOL pressure and a new CTO with a fresh rationalization mandate create a rare re-entry window. The 2022 no was not his decision.
              </div>
              <div style={{ display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:1,
                background:"rgba(255,255,255,.07)",borderRadius:8,overflow:"hidden",marginBottom:12 }}>
          ...
          <Reveal delay={100}>
            ...
            <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:9 }}>
              {[
                ...
                <div key={o.name} style={{ padding:"12px 13px",
                  background:"radial-gradient(ellipse 65% 55% at 12% 0%,rgba(255,255,255,.06) 0%,transparent 65%)",
                  border:`1px solid rgba(255,255,255,.1)`,borderLeft:`2px solid ${o.border}`,borderRadius:12,
                  ...
                  <div style={{ position:"absolute",top:10,right:10,fontSize:8,fontWeight:500,letterSpacing:".08em",
                    padding:"2px 7px",borderRadius:3,color:o.sigColor,background:o.sigBg }}>{o.sig}</div>
                  ...
                  <div style={{ marginTop:7,paddingTop:6,borderTop:"1px solid rgba(255,255,255,.06)",
                    fontSize:9.5,color:T.teal,fontStyle:"italic" }}>{o.action}</div>
                </div>
              ))}
            </div>
          </Reveal>
          ...
          <Reveal delay={160}>
            ...
            {[
              ...
              <div key={e.name} style={{ display:"flex",alignItems:"flex-start",gap:10,padding:"9px 12px",
                ...
                <div style={{ flex:1 }}>
                  <div style={{ fontFamily:"Georgia,serif",fontSize:12,fontWeight:300,marginBottom:2 }}>
                ...
                <span style={{ fontSize:8,fontWeight:500,letterSpacing:".07em",padding:"2px 8px",borderRadius:3,
                  whiteSpace:"nowrap",flexShrink:0,marginTop:2,color:e.bc,background:e.bb,border:`1px solid ${e.bbr}` }}>{e.badge}</span>
              </div>
            ))}
          </Reveal>
          ...
          <Reveal delay={220}>
            <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:14 }}>
              <div>
                ...
                {[["01","Why the 2022 Pilot Stalled","What specifically blocked — API gaps, multi-brand complexity, or champion loss? Arm with answers before the call."],
                  ["02","Oracle MICROS Migration Timeline","Which brands are actively replacing. Urgency level determines the entry point and motion."],
                  ["03","Franchise vs. Corporate Authority","Top-down mandate or franchisee-by-franchisee? This determines the entire sales play."],
                  ["04","PMS + Loyalty Integration Req","Confirm API coverage for Opera Cloud + Bonvoy. Address the 2022 blocker head-on."]].map(([n,t,b]) => (
                  <div key={n} style={{ display:"flex",gap:10,alignItems:"flex-start",padding:"8px 11px",
                    background:"rgba(255,255,255,.03)",border:"1px solid rgba(255,255,255,.07)",borderRadius:9,marginBottom:5 }}>
              ...
              <div>
                ...
                {[["✓",T.green,"Enterprise KDS live","— was the #1 gap in 2022 pilot. Now deployed at scale."],
                  ["✓",T.green,"Open APIs mature","— Opera Cloud + Bonvoy integration fully supported. Blocker is gone."],
                  ["✓",T.green,"Multi-brand menu mgmt","— centralized control with per-location overrides."],
                  ["⚡",T.amber,"MICROS EOL confirmed","— Oracle announced end-of-life. Active search underway."],
                  ["→",T.blue,"New CTO in seat 2023","— Drew Pinto. Rationalization mandate. The 2022 no was not his."]].map(([icon,c,t,b]) => (
                  <div key={t} style={{ display:"flex",gap:9,alignItems:"flex-start",padding:"7px 10px",
                    background:"rgba(255,255,255,.03)",border:"1px solid rgba(255,255,255,.07)",borderRadius:8,marginBottom:4 }}>
                    <div style={{ fontSize:9,flexShrink:0,paddingTop:2,width:12,color:c }}>{icon}</div>
                    <div style={{ fontSize:10.5,color:T.txt2,lineHeight:1.55 }}>
          ...
          <Reveal delay={280}>
            <div style={{ background:"radial-gradient(ellipse 65% 55% at 12% 0%,rgba(100,145,255,.10) 0%,transparent 65%),radial-gradient(ellipse 55% 45% at 88% 100%,rgba(45,212,180,.06) 0%,transparent 60%)",
              ...
              <div style={{ position:"absolute",top:0,left:0,right:0,height:1,
                background:"linear-gradient(90deg,transparent,rgba(100,145,255,.45),rgba(45,212,180,.3),transparent)" }} />
              ...
              <div style={{ fontSize:8.5,color:T.txt3,lineHeight:1.65,paddingTop:8,borderTop:"1px solid rgba(255,255,255,.07)" }}>
                Synthesized from: Marriott 2024 Annual Report · Q1 2025 Earnings · Drew Pinto LinkedIn (Mar 2025) · Oracle MICROS EOL (Jan 2025) · Square internal pilot data (2022) · Reviewed and framed by Joey Amari
              </div>
              <RefreshBtn />
            </div>
          </Reveal>
          ...
          <Reveal delay={340}>
            ...
            {[["▶","Restaurants Premium"," — Full-service F&B, course mgmt, multi-revenue-center reporting. MICROS replacement at lower TCO."],
              ...
              ["▶","Square Banking + Payroll"," — Expansion motion post-POS via confirmed NetSuite integration."]].map(([a,t,b]) => (
              <div key={t} style={{ display:"flex",alignItems:"flex-start",gap:8,padding:"7px 10px",
                background:"rgba(255,255,255,.03)",border:"1px solid rgba(255,255,255,.07)",borderRadius:8,marginBottom:4 }}>
        ...
        {/* ── RIGHT COL ── */}
        <div style={{ borderLeft:"1px solid rgba(255,255,255,.07)",padding:"20px 16px",overflowY:"auto",
          display:"flex",flexDirection:"column",gap:14 }}>

          <Reveal delay={80}>
            <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8 }}>
              <SecHdr label="Live Signals" />
              <div style={{ display:"flex",alignItems:"center",gap:5,fontSize:9,color:T.green,
                letterSpacing:".08em",fontWeight:500,marginBottom:12 }}>
                <div style={{ width:5,height:5,borderRadius:"50%",background:T.green,animation:"pulse 2s ease-in-out infinite" }} />
                LIVE
              </div>
            </div>
            {[
              ...
              return (
                <div key={title} style={{ padding:"9px 11px",background:"rgba(255,255,255,.03)",
                  border:"1px solid rgba(255,255,255,.07)",borderRadius:10,marginBottom:5 }}>
                  <div style={{ display:"flex",alignItems:"center",gap:7,marginBottom:4 }}>
                    <div style={{ width:5,height:5,borderRadius:"50%",flexShrink:0,background:dotColors[dot],
                      boxShadow:`0 0 6px ${dotColors[dot]}99` }} />
          ...
          <Reveal delay={140}>
            ...
            {[["#1","Re-engage Drew Pinto Direct","Cold re-intro with \"What's Changed\" framing. Lead with MICROS pressure. He knows Square — capability update, not a cold pitch."],
              ["#2","Activate Oracle Partner Path","Hayley Williams at Oracle has active Marriott relationship. Co-sell MICROS EOL + Square replacement through the partner channel."],
              ["#3","Courtyard GM Referral Loop","Re-engage pilot GMs via Stevie Nicks. Get updated testimonials and corporate referral intro to Drew Pinto's team."]].map(([n,t,b]) => (
              <div key={n} style={{ padding:"9px 11px",background:"rgba(255,255,255,.03)",
                border:"1px solid rgba(255,255,255,.07)",borderRadius:10,marginBottom:5 }}>
                <div style={{ display:"flex",alignItems:"center",gap:7,marginBottom:4 }}>
