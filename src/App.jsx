...
{/* Preview bullet when collapsed -- only for first card */}
{!open && role.badge && (
...
const transitionStyle = `opacity .6s ${delay}ms ease, transform .6s ${delay}ms cubic-bezier(.4,0,.2,1)`;
return (
<div ref={ref} style={{ opacity:visible?1:0, transform:visible?"none":"translateY(24px)", transition:transitionStyle }}>
{children}
</div>
);
}
...
["Closed an 18-month enterprise deal"," with a national commercial real estate developer , navigating a 20+ stakeholder buying committee across Legal, Finance, and board review, then managing a 5,000+ person implementation spanning firm employees and tenant organizations. Currently in active onboarding"],
...
groups:[
{ label:"Performance", bullets:[
["Averaged 190% quota attainment Q1-Q4"," sourcing enterprise pipeline across Healthcare, Hospitality, and QSR, with BDR-originated opportunities consistently outperforming team close rates, driven by account-level targeting with a specific business case behind every sequence."],
...
{ label:"Key Achievement", bullets:[["Promoted to Enterprise AE in 15 months"," through a path that didn't exist, the first BDR-to-Enterprise-AE transition in Square's history, requiring a custom career track to be built specifically for the move."]] },
]},
{ id:"r3",title:"Account Executive, SMB",meta:"May 2021 - February 2022 · L2",
groups:[
{ label:"Performance", bullets:[
["178% quota attainment"," (Q1: 175%, Q2: 195%, Q3: 165%) running full-cycle deals with multi-stakeholder buying processes"],
["Identified and developed the SuiteRetail partnership",", now a preferred Square Partner, building a referral network of 20+ midmarket and enterprise sellers generating one qualified lead per week"],
["Selected as the only SMB AE"," to partner with the Enterprise AE on Cardinal Health , multi-threading across 10+ stakeholders to build and scale the partnership"],
]},
...
groups:[
{ label:"Performance", bullets:[
["Averaged 182% quota attainment Q1-Q4",", consistently recognized among the top BDR performers across outbound activity, demo-set volume, and conversion rate"],
...
{ color:"#a8b8cc",name:"Prospecting Websites",problem:"Standard outbound sequences couldn't cut through noise in a competitive NYC enterprise market across the team.",desc:"Personalized prospect websites with custom branding and account-specific value messaging, showing exactly what Square uniquely delivers to each target, replacing generic outreach entirely.",tools:["Claude","MCP"],metrics:["8/15 NYC prospects responded","Within 3 weeks"] },
...
<div style={{ minHeight:isMobile?"calc(100svh - 48px)":"calc(100dvh - 52px)",display:"flex",flexDirection:"column",justifyContent:"flex-start",padding:isMobile?"44px 20px 0":"52px 44px 0",maxWidth:1060,margin:"0 auto",position:"relative",WebkitOverflowScrolling:"touch", }}>

          {/* Top, name, text, contact */}
          <div className="fu">
            ...
            <div className="fu3" style={{ fontSize:isMobile?14:16,fontWeight:300,color:"rgba(255,255,255,.85)",lineHeight:1.5,marginBottom:isMobile?14:18 }}>
              ...
              <strong style={{ color:T.txt,fontWeight:500 }}>Sales × Design × Automation</strong>.
            </div>
          ...
          <div className="fu4" style={{ display:"flex",flexDirection:"column",gap:isMobile?10:12,marginTop:isMobile?"5vh":"8vh" }}>
            ...
            <div style={{ width:"100%",background:"linear-gradient(145deg,rgba(255,255,255,.055) 0%,rgba(255,255,255,.018) 55%,rgba(255,255,255,.008) 100%)",border:"1px solid rgba(255,255,255,.18)",borderRadius:10,overflow:"hidden",boxShadow:"0 10px 36px rgba(0,0,0,.45),inset 0 1.5px 0 rgba(255,255,255,.16)",position:"relative" }}>
              ...
              {/* Shimmer sweep, one-time after load */}
            ...
            {/* Industry pills, same bar design */}
          ...
          {/* Divider + drop shadow below */}
          <div style={{ position:"absolute",bottom:0,left:"50%",transform:"translateX(-50%)",width:"100vw",zIndex:3 }}>
